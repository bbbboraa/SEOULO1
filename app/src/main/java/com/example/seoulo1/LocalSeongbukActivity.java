...
public class LocalSeongbukActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_seongbuk);
        ...
        button_restaurant.setOnClickListener(v -> {
            ...
            displayListFromAsset("seongbuk_food.txt", "seongbuk_food_url.txt");
        });
        ...
        button_cafe.setOnClickListener(v -> {
            ...
            button_tour.setSelected(false);
            button_shopping.setSelected(false);
            displayListFromAsset("seongbuk_cafe.txt", "seongbuk_cafe_url.txt");
        });
        ...
        button_tour.setOnClickListener(v -> {
            ...
            button_shopping.setSelected(false);
            displayListFromAsset("seongbuk_tour.txt", "seongbuk_tour_url.txt");
        });
        ...
        button_shopping.setOnClickListener(v -> {
            ...
            displayListFromAsset("seongbuk_shop.txt", "seongbuk_shop_url.txt");
        });
        ...
        menu_btn.setOnClickListener(view -> {
            ...
            //PopupMenu 객체 생성
            PopupMenu popup = new PopupMenu(LocalSeongbukActivity.this, view); //두 번째 파라미터가 팝업메뉴가 붙을 뷰
            ...
            popup.setOnMenuItemClickListener(menuItem -> {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.menu_my_location:
                        Intent intent1 = new Intent(LocalSeongbukActivity.this, MyLocationActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.menu_hot_place:
                        Intent intent2 = new Intent(LocalSeongbukActivity.this, LocalSelectActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.menu_route:
                        Intent intent3 = new Intent(LocalSeongbukActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.menu_checklist:
                        Intent intent4 = new Intent(LocalSeongbukActivity.this, CheckListActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.menu_travel_log:
                        Intent intent5 = new Intent(LocalSeongbukActivity.this, PlanActivity.class);
                        startActivity(intent5);
                        break;
                    case R.id.menu_expense_graph:
                        Intent intent6 = new Intent(LocalSeongbukActivity.this, GraphActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.menu_mypage:
                        Intent intent7 = new Intent(LocalSeongbukActivity.this, MypageActivity.class);
        ...
        like_btn.setOnClickListener(view ->{
            Intent intent8 = new Intent(LocalSeongbukActivity.this, LikeActivity.class);
    ...
    private void displayListFromAsset(String fileName, String urlFileName) {
        ...
        try {
            InputStream inputStream = getAssets().open("Seoul/Seongbuk/"+fileName);
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));

            InputStream urlInputStream = getAssets().open("Seoul/Seongbuk/"+urlFileName);
    ...
    private void openNaverUrl(String naverUrl) {
        ...
        try {
            ...
            if ("intent".equals(uri.getScheme())) {
                ...
                Context context = LocalSeongbukActivity.this;
                        ...
                        if (url.startsWith("https://") || url.startsWith("http://")) {
                            ...
                            try {
                                ...
                                if (isNaverMapInstalled()) {
                                    ...
                                    Log.e("LocalSeongbukActivity", "네이버 지도 앱이 설치되어 있지 않습니다.");
