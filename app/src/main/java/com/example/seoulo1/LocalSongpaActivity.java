...
public class LocalSongpaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_songpa);
        ...
        button_restaurant.setOnClickListener(v -> {
            ...
            displayListFromAsset("songpa_food.txt", "songpa_food_url.txt");
        });
        ...
        button_cafe.setOnClickListener(v -> {
            ...
            button_tour.setSelected(false);
            button_shopping.setSelected(false);
            displayListFromAsset("songpa_cafe.txt", "songpa_cafe_url.txt");
        });
        ...
        button_tour.setOnClickListener(v -> {
            ...
            button_shopping.setSelected(false);
            displayListFromAsset("songpa_tour.txt", "songpa_tour_url.txt");
        });
        ...
        button_shopping.setOnClickListener(v -> {
            ...
            displayListFromAsset("songpa_shop.txt", "songpa_shop_url.txt");
        });
        ...
        menu_btn.setOnClickListener(view -> {
            ...
            //PopupMenu 객체 생성
            PopupMenu popup = new PopupMenu(LocalSongpaActivity.this, view); //두 번째 파라미터가 팝업메뉴가 붙을 뷰
            ...
            popup.setOnMenuItemClickListener(menuItem -> {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.menu_my_location:
                        Intent intent1 = new Intent(LocalSongpaActivity.this, MyLocationActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.menu_hot_place:
                        Intent intent2 = new Intent(LocalSongpaActivity.this, LocalSelectActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.menu_route:
                        Intent intent3 = new Intent(LocalSongpaActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.menu_checklist:
                        Intent intent4 = new Intent(LocalSongpaActivity.this, CheckListActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.menu_travel_log:
                        Intent intent5 = new Intent(LocalSongpaActivity.this, PlanActivity.class);
                        startActivity(intent5);
                        break;
                    case R.id.menu_expense_graph:
                        Intent intent6 = new Intent(LocalSongpaActivity.this, GraphActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.menu_mypage:
                        Intent intent7 = new Intent(LocalSongpaActivity.this, MypageActivity.class);
        ...
        like_btn.setOnClickListener(view ->{
            Intent intent8 = new Intent(LocalSongpaActivity.this, LikeActivity.class);
    ...
    private void displayListFromAsset(String fileName, String urlFileName) {
        ...
        try {
            InputStream inputStream = getAssets().open("Seoul/Songpa/"+fileName);
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));

            InputStream urlInputStream = getAssets().open("Seoul/Songpa/"+urlFileName);
    ...
    private void openNaverUrl(String naverUrl) {
        ...
        try {
            ...
            if ("intent".equals(uri.getScheme())) {
                ...
                Context context = LocalSongpaActivity.this;
                        ...
                        if (url.startsWith("https://") || url.startsWith("http://")) {
                            ...
                            try {
                                ...
                                if (isNaverMapInstalled()) {
                                    ...
                                    Log.e("LocalSongpaActivity", "네이버 지도 앱이 설치되어 있지 않습니다.");
