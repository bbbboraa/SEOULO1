...
public class LocalJongnoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_jongno);
        ...
        button_restaurant.setOnClickListener(v -> {
            ...
            displayListFromAsset("jongno_food.txt", "jongno_food_url.txt");
        });
        ...
        button_cafe.setOnClickListener(v -> {
            ...
            button_tour.setSelected(false);
            button_shopping.setSelected(false);
            displayListFromAsset("jongno_cafe.txt", "jongno_cafe_url.txt");
        });
        ...
        button_tour.setOnClickListener(v -> {
            ...
            button_shopping.setSelected(false);
            displayListFromAsset("jongno_tour.txt", "jongno_tour_url.txt");
        });
        ...
        button_shopping.setOnClickListener(v -> {
            ...
            displayListFromAsset("jongno_shop.txt", "jongno_shop_url.txt");
        });
        ...
        menu_btn.setOnClickListener(view -> {
            ...
            //PopupMenu 객체 생성
            PopupMenu popup = new PopupMenu(LocalJongnoActivity.this, view); //두 번째 파라미터가 팝업메뉴가 붙을 뷰
            ...
            popup.setOnMenuItemClickListener(menuItem -> {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.menu_my_location:
                        Intent intent1 = new Intent(LocalJongnoActivity.this, MyLocationActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.menu_hot_place:
                        Intent intent2 = new Intent(LocalJongnoActivity.this, LocalSelectActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.menu_route:
                        Intent intent3 = new Intent(LocalJongnoActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.menu_checklist:
                        Intent intent4 = new Intent(LocalJongnoActivity.this, CheckListActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.menu_travel_log:
                        Intent intent5 = new Intent(LocalJongnoActivity.this, PlanActivity.class);
                        startActivity(intent5);
                        break;
                    case R.id.menu_expense_graph:
                        Intent intent6 = new Intent(LocalJongnoActivity.this, GraphActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.menu_mypage:
                        Intent intent7 = new Intent(LocalJongnoActivity.this, MypageActivity.class);
        ...
        like_btn.setOnClickListener(view ->{
            Intent intent8 = new Intent(LocalJongnoActivity.this, LikeActivity.class);
    ...
    private void displayListFromAsset(String fileName, String urlFileName) {
        ...
        try {
            InputStream inputStream = getAssets().open("Seoul/Jongno/"+fileName);
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));

            InputStream urlInputStream = getAssets().open("Seoul/Jongno/"+urlFileName);
    ...
    private void openNaverUrl(String naverUrl) {
        ...
        try {
            ...
            if ("intent".equals(uri.getScheme())) {
                ...
                Context context = LocalJongnoActivity.this;
                        ...
                        if (url.startsWith("https://") || url.startsWith("http://")) {
                            ...
                            try {
                                ...
                                if (isNaverMapInstalled()) {
                                    ...
                                    Log.e("LocalJongnoActivity", "네이버 지도 앱이 설치되어 있지 않습니다.");
