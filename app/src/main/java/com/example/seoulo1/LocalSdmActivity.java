...
public class LocalSdmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_local_sdm);
        ...
        button_restaurant.setOnClickListener(v -> {
            ...
            displayListFromAsset("sdm_food.txt", "sdm_food_url.txt");
        });
        ...
        button_cafe.setOnClickListener(v -> {
            ...
            button_tour.setSelected(false);
            button_shopping.setSelected(false);
            displayListFromAsset("sdm_cafe.txt", "sdm_cafe_url.txt");
        });
        ...
        button_tour.setOnClickListener(v -> {
            ...
            button_shopping.setSelected(false);
            displayListFromAsset("sdm_tour.txt", "sdm_tour_url.txt");
        });
        ...
        button_shopping.setOnClickListener(v -> {
            ...
            displayListFromAsset("sdm_shop.txt", "sdm_shop_url.txt");
        });
        ...
        menu_btn.setOnClickListener(view -> {
            ...
            //PopupMenu 객체 생성
            PopupMenu popup = new PopupMenu(LocalSdmActivity.this, view); //두 번째 파라미터가 팝업메뉴가 붙을 뷰
            ...
            popup.setOnMenuItemClickListener(menuItem -> {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.menu_my_location:
                        Intent intent1 = new Intent(LocalSdmActivity.this, MyLocationActivity.class);
                        startActivity(intent1);
                        break;

                    case R.id.menu_hot_place:
                        Intent intent2 = new Intent(LocalSdmActivity.this, LocalSelectActivity.class);
                        startActivity(intent2);
                        break;

                    case R.id.menu_route:
                        Intent intent3 = new Intent(LocalSdmActivity.this, CalendarActivity.class);
                        startActivity(intent3);
                        break;
                    case R.id.menu_checklist:
                        Intent intent4 = new Intent(LocalSdmActivity.this, CheckListActivity.class);
                        startActivity(intent4);
                        break;
                    case R.id.menu_travel_log:
                        Intent intent5 = new Intent(LocalSdmActivity.this, PlanActivity.class);
                        startActivity(intent5);
                        break;
                    case R.id.menu_expense_graph:
                        Intent intent6 = new Intent(LocalSdmActivity.this, GraphActivity.class);
                        startActivity(intent6);
                        break;
                    case R.id.menu_mypage:
                        Intent intent7 = new Intent(LocalSdmActivity.this, MypageActivity.class);
        ...
        like_btn.setOnClickListener(view ->{
            Intent intent8 = new Intent(LocalSdmActivity.this, LikeActivity.class);
    ...
    private void displayListFromAsset(String fileName, String urlFileName) {
        ...
        try {
            InputStream inputStream = getAssets().open("Seoul/Sdm/"+fileName);
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream));

            InputStream urlInputStream = getAssets().open("Seoul/Sdm/"+urlFileName);
    ...
    private void openNaverUrl(String naverUrl) {
        ...
        try {
            ...
            if ("intent".equals(uri.getScheme())) {
                ...
                Context context = LocalSdmActivity.this;
                        ...
                        if (url.startsWith("https://") || url.startsWith("http://")) {
                            ...
                            try {
                                ...
                                if (isNaverMapInstalled()) {
                                    ...
                                    Log.e("LocalSdmActivity", "네이버 지도 앱이 설치되어 있지 않습니다.");
